...
export default class ExtentNavigate extends BaseTool<BaseToolProps, unknown> {
  ...
  getExpandPanel (): React.JSX.Element {
    ...
    const rootClassName = classNames('extent-navigate-map-tool d-flex', { 'horizontal-direction': isHorizontal, 'vertical-direction': !isHorizontal })
    ...
    return (
      <div className={rootClassName} css={this.getStyle()}>
        <div
          role='button'
          tabIndex={isPrevBtnDisabled ? -1 : 0}
        ...
        <div
          role='button'
          tabIndex={isNextBtnDisabled ? -1 : 0}
