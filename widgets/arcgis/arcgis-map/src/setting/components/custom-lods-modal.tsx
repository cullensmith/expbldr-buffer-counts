    ...
    <React.Fragment>
      ...
      >
        ...
        <ModalBody className='w-auto pt-5'>
          ...
          <div className='lod-list mt-6 pl-2 pr-2' role='list'>
            {
              finalLodsState?.length > 0 && finalLodsState.map((lod, index) => {
                return (
                  <div
                    ...
                    tabIndex={0}
                    role='listitem'
                    aria-label={lod.scale?.toString()}
                  >
                    <div className='lod-scale-text w-100'>{lod.scale}</div>
                    <CloseOutlined
                      className='delete-icon ml-2'
                      tabIndex={0}
                      aria-label={deleteLabel}
                      onClick={() => { onClickLodDeleteIcon(index) }}
                    />
                  </div>
                )
              })
